...
- готовый нагрузочный тест для PostgreSQL сервиса;
...
- Красная линия — реактивное приложение на WebFlux  
  ...
  - Работа потоков реактивного приложения при нагрузке(Потоки не простаивают)
  ![Сравнение WebFlux и классического приложения по работе потоков(WebFlux)](docs/Работа_потоков_WebFlux.jpg)

  - Работа потоков классического приложения при нагрузке(Потоки простаивают)
  ![Сравнение WebFlux и классического приложения по работе потоков(Классика)](docs/Работа_потоков_БезWebFlux.jpg)

  - Пропускная способность реактивного приложения
  ![График пропускной способности реактивного приложения по сравнению с классическом](docs/Пропускная_способность.jpg)
  
  - CPU реактивного приложения
  ![График CPU реактивного приложение по сравнению с классическом](docs/СPU.jpg)
  
  - Память реактивного приложения
